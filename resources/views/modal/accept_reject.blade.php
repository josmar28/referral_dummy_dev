                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade in active">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                <td>LMP: <input type="text" class="form-control lmp_date" name="lmp" placeholder="mm/dd/yyyy" style="width: 100%;" disabled>   </td>
                                                <td>EDC/EDD: <input type="text" class="form-control edc_edd" name="edc_edd" placeholder="mm/dd/yyyy" style="width: 100%;" disabled></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Td1: <input type="text" placeholder="mm/dd/yyyy" class="form-control td1" name="td1" style="width: 100%;" disabled></td>
                                                <td>Td2: <input type="text" placeholder="mm/dd/yyyy" class="form-control td2" name="td2" style="width: 100%;" disabled> </td>
                                                <td>Td3: <input type="text" placeholder="mm/dd/yyyy" class="form-control td3" name="td3" style="width: 100%;" disabled> </td>
                                                <td>Td4: <input type="text" placeholder="mm/dd/yyyy" class="form-control td4" name="td4" style="width: 100%;" disabled> </td>
                                                <td>Td5: <input type="text" placeholder="mm/dd/yyyy" class="form-control td5" name="td5" style="width: 100%;" disabled> </td>
                                            </tr>
                                        </table>
                                </div>
